...
This project is inspired by the [{bookdown}](https://bookdown.org/) and [{thesisdown}](http://thesisdown.rbind.io/) packages, adapted to provide a template for writing a McMaster graduate thesis in R markdown.
...
![New RStudio Project](man/figures/create-new-project.png)

Create your project in a new directory: 

![Choose New Directory](man/figures/choose-new-directory.png)

For the type of project select "Thesis Project using macdown":

![Type of project](man/figures/choose-thesis-project.png)
...
If you are new to working with these packages, there is much more information and examples available at [{bookdown}](https://bookdown.org/) and [{rmarkdown}](https://rmarkdown.rstudio.com/). 
