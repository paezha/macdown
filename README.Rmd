...
This project is inspired by the [{bookdown}](https://github.com/rstudio/bookdown) and [{thesisdown}](https://github.com/ismayc/thesisdown) packages, adapted to provide a template for writing a McMaster graduate thesis in R markdown.
